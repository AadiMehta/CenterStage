...
class LessonCreateFormStep2(forms.Form):
    ...
    session_date = forms.CharField(max_length=100, required=False)
    session_start_time = forms.CharField(max_length=100, required=False)
    session_end_time = forms.CharField(max_length=100, required=False)
    weekdays = forms.CharField(max_length=100, required=False)
